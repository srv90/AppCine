...
<body>
	...
	<div class="container theme-showcase" role="main">
				...
				<c:forEach var="horario" items="${horarios.content}">
					<tr>
						...
						<td>
							...
							<a href="${urlHorarios}/delete/${horario.id}" onclick='return confirm("¿Estás seguro?")' class="btn btn-danger btn-sm" role="button" title="Eliminar"><span class="glyphicon glyphicon-trash"></span></a>
						</td>
					</tr>
				</c:forEach>
		...
		<nav aria-label="">
			<ul class="pager">
				<c:choose>
					<c:when test="${horarios.first }">
						<li><a
							href="${urlHorarios}/indexPaginate?page=${horarios.number + 1 }">Siguiente</a></li>
					</c:when>
					<c:when test="${horarios.number eq horarios.totalPages }">
						<li><a
							href="${urlHorarios}/indexPaginate?page=${horarios.number - 1 }">Anterior</a></li>
						<h2>No hay mas registros disponibles</h2>
					</c:when>
					<c:otherwise>
						<li><a
							href="${urlHorarios}/indexPaginate?page=${horarios.number - 1 }">Anterior</a></li>
