         ...
         <c:forEach items="${peliculas.content}" var="pelicula">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${urlDelete}/${pelicula.id}" class="btn btn-danger btn-sm" onclick='return confirm("¿Estás seguro?")' role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
                </td>
            </tr>  
         </c:forEach>      
        </table>
        	<nav aria-label="">
				<ul class="pager">
					...
					<c:when test="${horarios.number eq horarios.totalPages }">
						...
						<h2>No hay más registros disponibles</h2>
					</c:when>
					<c:otherwise>
						<li><a
							href="${urlPeliculas}/indexPaginate?page=${peliculas.number - 1 }">Anterior</a></li>
