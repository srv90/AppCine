...
<html lang="en">
   ...
   <body>
      ...
      <div class="container theme-showcase" role="main">
         ...
         <form:form action="${urlRoot}contacto" modelAttribute="contacto" method="post" class="form-horizontal">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <form:select id="genero" path="generos" multiple="multiple" items="${generos}" class="form-control"/>     
               </div>
            </div>
